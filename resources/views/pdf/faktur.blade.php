...
<body style='font-family: tahoma; font-size: 8pt;'>
    <center>
        <table style='width: 350px; font-size: 16pt; font-family: calibri; border-collapse: collapse;' border='0'>
            <tr>
                <td width='70%' align='CENTER' vertical-align:top>
                    ...
                    <span style='font-size: 12pt'>No. : #{{ $order['id_transaksi'] }},
        ...
        <table cellspacing='0' cellpadding='0' style='width: 350px; font-size: 12pt; font-family: calibri; border-collapse: collapse;' border='0'>
            ...
            <tr>
                <td style='vertical-align: top'>{{ $item->menu->nama }}</td>
                <td style='vertical-align: top; text-align: right; padding-right: 10px'>
                    Rp {{ number_format($item->menu->harga, 0, ',', '.') }}</td>
                <td style='vertical-align: top; text-align: right; padding-right: 10px'>{{ $item['jumlah'] }}</td>
                <td style='text-align: right; vertical-align: top'>{{ $item['keterangan'] }}
                </td>
