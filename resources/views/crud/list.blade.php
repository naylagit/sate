...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center p-4">Data Karyawan
    </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a class="btn btn-datatable btn-icon btn-transparent-dark me-2" href="/{{ $page }}/{{ $d['id'] }}/edit"><i data-feather="edit"></i></a>
                        <form action="{{ url($page . '/' . $d['id']) }}" method="POST" style="display:inline;">
                            @csrf
                            @method('DELETE')
