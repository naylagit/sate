                ...
                <div class="card-body">
                    ...
                    <div class="row  mb-3">
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control" id="" name="" type="text" placeholder=" Nomor Pesanan" value={{ $id }} readonly />
                        </div>
                        <input class="form-control" id="id_transaksi" name="id_transaksi" type="hidden" placeholder=" Nomor Pesanan" value={{ $id_transaksi }} readonly />
                        <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            ...
                            <input class="form-control" id="nm_cust" name="nm_cust" type="text" placeholder=" Nama Customer" required />
                        </div>
            ...
            <div class="card-body">
                ...
                <div class="row ">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input class="form-control" id="keterangan" name="keterangan" type="text" placeholder=" Masukkan Keterangan" required />
