                        ...
                        <div class="row  mb-3">
                            <div class="col-md-6 mb-3">
                                ...
                                <input class="form-control" id="" name="" type="text"
                                    placeholder=" Nomor Pesanan" value={{ $data->id }} readonly />
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <input class="form-control" id="nm_cust" name="nm_cust" type="text"
                                    value="{{ $data->nm_cust }}" placeholder=" Nama Customer" required />
                            </div>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="row ">
                        ...
                        <div id="cash_payment" class="row d-none">
...
@push('scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const pesananMenu = @json($pesananMenu);
            const DataMenu = @json($menu);
            const tableBody = document.getElementById('tableBody'); // Ensure this matches your table body ID
            let itemNumber = 1;

            pesananMenu.forEach(menu => {
                const newRow = document.createElement('tr');
                const subtotal_display = 'Rp ' + parseInt(menu.subtotal).toLocaleString();

                newRow.innerHTML = `
                    <td>${itemNumber}</td>
                    <td>${DataMenu[menu.menu_id].nama}</td>
                    <td>${parseInt(menu.jumlah)}</td>
                    <td class='d-none'>${menu.subtotal}</td>
            ...
            updateTotal(); // Call this function to update the total based on the preloaded data
        });
        ...
        function updateTotal() {
            ...
            document.getElementById('totalDisplay').value = 'Rp ' + total.toLocaleString();
