...
@endif
<div class="modal fade" id="successModal" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="successModalTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body d-flex justify-content-center"><i class="text-green" data-feather="check-circle" style="height: 75px; width: 75px;"></i></div>
            ...
            <div class="card-body">
                ...
                <div class="row  mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control" id="jumlah" name="jumlah" type="text" placeholder=" jumlah" />
                    </div>
                ...
                <div class="row  mb-3">
                    <div class="col-md-6">
                        ...
                        <input class="form-control" id="subtotal" name="subtotal" type="text" placeholder=" subtotal" />
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row  mb-3">
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control" id="" name="" type="text" placeholder=" Nomor Pesanan" value={{ $data->id }} readonly />
                        </div>
                        <input class="form-control" id="id_transaksi" name="id_transaksi" type="hidden" placeholder=" Nomor Pesanan" value={{ $data->id_transaksi }} readonly />
                        <div class="col-md-6">
                            <label class="small mb-1" for="">Waktu Pesanan</label>
                            <input class="form-control" id="" name="" type="text" placeholder=" " value="{{ date('Y-m-d H:i:s') }}" readonly />
                        </div>
                        <div class="col-md-12">
                            <label class="small mb-1" for="nm_cust">Nama Customer</label>
                            <input class="form-control" id="nm_cust" name="nm_cust" type="text" placeholder=" Nama Customer"  value={{ $data->nm_cust }} required />
                        </div>
            ...
            <div class="card-body">
                ...
                <div class="row mb-3 gx-3">
                    <div class="col-md-6">
                        ...
                        <select class="form-select" id="jenis" name="jenis" aria-label="Default select example" readonly>
                            <option selected disabled>Pilih Jenis Pesanan:</option>
                            <option value="1" {{ $data->jenis == 1 ? 'selected' : '' }}>
                                Dine In
                            </option>
                            <option value="2" {{ $data->jenis == 2 ? 'selected' : '' }}>
                                Take Out
                            </option>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select" id="meja_id" name="meja_id" aria-label="Default select example">
                            <option selected disabled>Pilih Meja:</option>

                            @foreach ($meja as $item)
                            <option value="{{ $item['id'] }}" {{ $data->meja_id == $item['id'] ? 'selected' : '' }}>
                                {{ $item['nama'] }}
                            </option>
                            @endforeach
            ...
            <div class="card-body">
                ...
                <div class="row ">
                    <div class="col-md-12 mb-3">
                        ...
                        <input class="form-control" id="total" name="total" type="text" placeholder=" Total" value={{ $data->total }} readonly />
                    </div>

                    <div class="col-md-6 mb-3">
                        <label class="small mb-1">Metode Pembayaran</label>
                        <select class="form-select" id="metode_pembayaran" name="metode_pembayaran" aria-label="Default select example">
                            <option selected disabled>Metode Pembayaran:</option>
                            <option value="cash" {{ $data->metode_pembayaran == 'cash' ? 'selected' : '' }}>
                                Cash
                            </option>
                            <option value="qris" {{ $data->metode_pembayaran == 'qris' ? 'selected' : '' }}>
                                Debit
                            </option>
                        </select>
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input class="form-control" id="keterangan" name="keterangan" type="text" placeholder=" Masukkan Keterangan" value={{ $data->keterangan }} readonly />

                    </div>

                    <div class="col-md-12 mb-3">
                        <label class="small mb-1" for="dibayarkan">Dibayarkan</label>
                        <input class="form-control" id="dibayarkan" name="dibayarkan" type="text" placeholder=" Masukkan Jumlah Dibayarkan" />
                    </div>
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <input class="form-control" id="kembalian" name="kembalian" type="text" placeholder="Jumlah Kembalian" readonly />
                    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let itemNumber = 2; // To keep track of the item number
