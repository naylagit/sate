            ...
            <div class="page-header-content">
                <div class="row align-items-center justify-content-between pt-3">
                    ...
                    <div class="col-12 col-xl-auto mb-3">
                        <a class="btn btn-sm btn-light text-primary" href="/pengeluaran/create">
...
@section('content')
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">Daftar {{ Str::ucfirst($page) }}
            <a class="btn btn-green " href='/pengeluaran/export'>
                            ...
                            @if ($d['kategori_id'] != 1)
                                <td class="text-center">
                                    <a class="btn btn-datatable btn-icon btn-transparent-dark me-2"
                                        href="/pengeluaran/{{ $d['id'] }}/edit"><i data-feather="edit"></i></a>
                                    <form action="{{ url('pengeluaran/' . $d['id']) }}" method="POST"
